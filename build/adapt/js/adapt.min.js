...
define('extensions/adapt-stars/js/adapt-starsView',["backbone", "core/js/adapt"], function (Backbone, Adapt) {
  var collection;
...
define('extensions/adapt-stars/js/adapt-stars',["backbone", "core/js/adapt", "./adapt-starsView"], function (
  Backbone,
  Adapt,
  StarsView
) {
...
;
define("plugins", ["components/adapt-contrib-mcq/js/adapt-contrib-mcq","components/adapt-contrib-text/js/adapt-contrib-text","extensions/adapt-contrib-pageLevelProgress/js/adapt-contrib-pageLevelProgress","extensions/adapt-contrib-tutor/js/adapt-contrib-tutor","extensions/adapt-stars/js/adapt-stars","menu/adapt-contrib-boxMenu/js/adapt-contrib-boxMenu","theme/adapt-contrib-vanilla/js/theme"], function(){});
